...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-b45ydy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-b45ydy.containers.anotherwebservice.com/
...
```
git clone git@github.com:AHDAMAD/container-b45ydy.git
cd container-b45ydy
```
...
```
docker attach container-b45ydy
```
